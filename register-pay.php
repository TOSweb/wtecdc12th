...
$sql = "SELECT * FROM register where id='$idd'";
...
<body class="home-3">
   ...
   <li class="nav-item"><a class="nav-link" href="speakers.html">Speakers</a></li> 
    ...
    <main class="main">
    <div class="classs1">
    <img src="img/mp.jpg" width="100%">
    </div>
    
        <!-- register pay area -->
        
                <!-- partner area -->
        <div class="partner-area1 partner-bg1 pt-40 pb-40">
            <div class="container">


  <form action="https://www.paypal.com/cgi-bin/webscr"
            method="post" target="_top">
                <!---   <form action="https://www.paypal.com/donate?hosted_button_id=BHJ35AELBN58W"
            method="post" target="_top"> -->
              
                <input type='hidden' name='business'
                value='payments@usindiasmecouncil.org'>
                <input type='hidden'
                name='item_name' value='Tamils Economic Conference'>
                <input type='hidden'
                name='item_number' value='<?php echo $iv; ?>' required>
                <input type='hidden'
               ...
               <!-- <input type='hidden'
                ...
                <input type='hidden'
                name='notify_url'
                value='https://12thwtecdc.com/notify.php'>
            <input type='hidden' name='cancel_return'
                value='https://12thwtecdc.com/cancel.php'>

            <input type='hidden' name='return'
                value='https://12thwtecdc.com/thankyou.php'>
                <div class="text-center mt-0 wow fadeInUp" data-wow-delay=".25s">
                   <input type="hidden" name="cmd" value="_xclick">
                <input type="submit" name="pay_now"  id="pay_now"
                Value="Pay Now" class="theme-btn theme-btn1">
                </form>
                    ...
                    <div class="col-lg-12">
                        <div class="site-heading text-center wow fadeInDown" data-wow-delay=".25s">
                            ...
                            <h2 class="site-title" style="color:#000">Thank you for <br> <span>Registering / Sponsorship</span></h2>
                        </div>
                    </div>
        </div>
                </div>
